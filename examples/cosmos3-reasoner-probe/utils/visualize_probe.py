...
td.q {{ max-width: 480px; color: #555; font-size: 11px; }}
...
stride {meta["stride"]} · {len(records)} judgements — click a row to seek the video</div>
...
function seek(t) {{ v.currentTime = t; v.pause(); }}
</script></body></html>""")
